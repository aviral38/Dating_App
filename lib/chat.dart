...
import 'user/message.dart';
import 'user/user.dart';
import 'user/chatt.dart';
...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  getCUser() async
  {
    ...
    Message message=await getLastMessage(currentUserId: widget.userId,selectedUserId: widget.selectedUserId);
                  ...
                  Row(children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        chat.lastMessage!=null?Text(chat.lastMessage,
